      ...
      <div className="flex gap-8">
        ...
        <div className="relative flex-shrink-0 w-48">
          <div
            ...
            } shadow-[0_0_12px_rgba(251,191,36,0.6)] rounded-full`}
          />
          <motion.button
            onClick={() => setIsExpanded(!isExpanded)}
            className="absolute right-[-18px] w-9 h-9 rounded-full bg-white dark:bg-gray-800 border-[3px] border-amber-400 flex items-center justify-center cursor-pointer hover:bg-amber-50 dark:hover:bg-gray-700 shadow-lg hover:shadow-amber-200 dark:hover:shadow-amber-900 transition-all"
            whileHover={{ 
              scale: 1.02,
              borderColor: '#FBBF24',
            }}
          ...
          <div className="text-base font-bold py-1.5 px-4 text-right pr-8 rounded-lg bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/30 dark:to-orange-900/30 border border-amber-200 dark:border-amber-700/50">
